...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Text('Profile'), backgroundColor: Colors.transparent),
      body: ListView(
        ...
        children: [
          ...
          FilledButton.icon(
            onPressed: () => SharePlus.instance.share(
              ShareParams(
                text:
                    'I reached Level ${profile.level} in Terminal Hero. Learn Linux with Terminal Hero.',
              ),
            ),
            ...
            children: [
              for (final badge in profile.badges)
                Chip(
                  ...
                  side:
                      BorderSide(color: AppTheme.neon.withValues(alpha: 0.16)),
                ),
          ...
          NeonCard(
            child: Column(
              ...
              children: [
                ...
                const Text(
                    'No ads, unlimited AI tutor, advanced missions, exclusive badges.'),
                const SizedBox(height: 12),
                OutlinedButton.icon(
                  onPressed: () {},
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text(value,
            style: const TextStyle(
                color: AppTheme.neon, fontWeight: FontWeight.w900)),
